...
function Forgotpass() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-orange-200 to-orange-300">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full opacity-95">
        ...
        <p
          className={`${
            emailSent ? "text-green-400 font-medium " : "text-red-500"
